...
var (
	filter_ReportMonthService_GetDetailList_0 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_ReportMonthService_GetDetailList_0(ctx context.Context, marshaler runtime.Marshaler, client ReportMonthServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDetailListReportMonthRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ReportMonthService_GetDetailList_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_ReportMonthService_GetDetailList_0(ctx context.Context, marshaler runtime.Marshaler, server ReportMonthServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDetailListReportMonthRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_ReportMonthService_GetDetailList_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterReportMonthServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ReportMonthServiceServer) error {
	...
	mux.Handle("GET", pattern_ReportMonthService_GetDetailList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_ReportMonthService_GetDetailList_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ReportMonthService_GetDetailList_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterReportMonthServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ReportMonthServiceClient) error {
	...
	mux.Handle("GET", pattern_ReportMonthService_GetDetailList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ReportMonthService_GetDetailList_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ReportMonthService_GetDetailList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"api", "report-month", "id", "detail-list"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_ReportMonthService_GetDetailList_0 = runtime.ForwardResponseMessage
)
