...
func local_request_ReportCheckMonthService_Create_0(ctx context.Context, marshaler runtime.Marshaler, server ReportCheckMonthServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq CreateReportCheckMonthRequest
	var metadata runtime.ServerMetadata
...
func local_request_ReportCheckMonthService_Get_0(ctx context.Context, marshaler runtime.Marshaler, server ReportCheckMonthServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetReportCheckMonthRequest
	var metadata runtime.ServerMetadata
...
func local_request_ReportCheckMonthService_Update_0(ctx context.Context, marshaler runtime.Marshaler, server ReportCheckMonthServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdateReportCheckMonthRequest
	var metadata runtime.ServerMetadata
...
func local_request_ReportCheckMonthService_Delete_0(ctx context.Context, marshaler runtime.Marshaler, server ReportCheckMonthServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteReportCheckMonthRequest
	var metadata runtime.ServerMetadata
...
func local_request_ReportCheckMonthService_List_0(ctx context.Context, marshaler runtime.Marshaler, server ReportCheckMonthServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListReportCheckMonthRequest
	var metadata runtime.ServerMetadata

	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_ReportCheckMonthService_List_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_ReportCheckMonthService_GetDetailList_0 = &utilities.DoubleArray{Encoding: map[string]int{"id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_ReportCheckMonthService_GetDetailList_0(ctx context.Context, marshaler runtime.Marshaler, client ReportCheckMonthServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDetailListReportCheckMonthRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ReportCheckMonthService_GetDetailList_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_ReportCheckMonthService_GetDetailList_0(ctx context.Context, marshaler runtime.Marshaler, server ReportCheckMonthServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDetailListReportCheckMonthRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_ReportCheckMonthService_GetDetailList_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
// RegisterReportCheckMonthServiceHandlerServer registers the http handlers for service ReportCheckMonthService to "mux".
// UnaryRPC     :call ReportCheckMonthServiceServer directly.
// StreamingRPC :currently unsupported pending https://github.com/grpc/grpc-go/issues/906.
func RegisterReportCheckMonthServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ReportCheckMonthServiceServer) error {
	...
	mux.Handle("POST", pattern_ReportCheckMonthService_Create_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ReportCheckMonthService_Create_0(rctx, inboundMarshaler, server, req, pathParams)
	...
	mux.Handle("GET", pattern_ReportCheckMonthService_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ReportCheckMonthService_Get_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("PUT", pattern_ReportCheckMonthService_Update_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ReportCheckMonthService_Update_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("DELETE", pattern_ReportCheckMonthService_Delete_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ReportCheckMonthService_Delete_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ReportCheckMonthService_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ReportCheckMonthService_List_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ReportCheckMonthService_GetDetailList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_ReportCheckMonthService_GetDetailList_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ReportCheckMonthService_GetDetailList_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterReportCheckMonthServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ReportCheckMonthServiceClient) error {
	...
	mux.Handle("GET", pattern_ReportCheckMonthService_GetDetailList_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ReportCheckMonthService_GetDetailList_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ReportCheckMonthService_GetDetailList_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"api", "report-check-month", "id", "detail-list"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_ReportCheckMonthService_GetDetailList_0 = runtime.ForwardResponseMessage
)
